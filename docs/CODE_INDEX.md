...
| `/learn` | `(tabs)/learn.tsx` | Articles, with a bookmark toggle and a "Saved" filter chip; reader at `article/[slug].tsx` (bookmark toggle mirrors the back button) |
