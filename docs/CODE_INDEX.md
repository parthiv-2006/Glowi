...
`useLearnFavorites`/`useToggleLearnFavorite` (article bookmarks, optimistic toggle + rollback), …) |
...
(freeform per-step note, nullable, no RLS change).
