/**
 * Legal copy — single source of truth for the in-app screens (/legal/privacy,
 * /legal/terms) and, via the web export, the public URLs the store forms
 * reference. docs/legal/*.md mirror this text for reviewers; change both
 * together. DRAFT until the owner signs off (see the C1 task in
 * polish_product.md).
 */

export const LEGAL_UPDATED = '2026-07-11';

export const PRIVACY_POLICY = `# Glowi Privacy Policy

**Draft — pending owner/legal review. Last updated ${LEGAL_UPDATED}.**
...
export const TERMS_OF_SERVICE = `# Glowi Terms of Service

**Draft — pending owner/legal review. Last updated ${LEGAL_UPDATED}.**

By creating an account or continuing as a guest, you agree to these terms.

## What Glowi is — and isn't

Glowi provides AI-generated skincare information for **cosmetic and wellness purposes
only**. It describes the visible appearance of skin and suggests routines and widely
available products. Glowi is **not a medical device, does not diagnose, treat, or cure
any condition, and is not a substitute for professional care**. For anything painful,
spreading, rapidly changing, or worrying — including suspicious moles — see a
dermatologist or physician. Never delay seeking medical advice because of something
Glowi said.

## Your account

You are responsible for the accuracy of what you log and for keeping your credentials
safe. Guest accounts inactive for 90 days are deleted automatically. You can delete your
account, and everything in it, at any time from Profile.

## Acceptable use

Don't attempt to break, overload, reverse-engineer, or abuse the service; don't upload
content you have no right to; don't use Glowi for anyone's skin but your own without
their consent. Automated or bulk use of the AI features is not permitted, and requests
are rate-limited.

## AI content

AI output can be wrong, incomplete, or generic despite our safeguards. Product
suggestions come from a curated catalog; availability and pricing are not guaranteed,
and Glowi earns nothing from purchases. Patch-test new products and check ingredient
lists yourself if you have allergies.

## Intellectual property

The app, its design, and its content are Glowi's. Your photos and logs remain yours; you
grant us only the processing rights needed to run the service for you (including AI
...
law, Glowi's liability for any claim related to the service is limited to the amount you
paid for it (currently: nothing). Nothing in these terms excludes liability that cannot
lawfully be excluded.

## Changes

We may update these terms; material changes will be shown in the app. Continuing to use
Glowi after changes take effect means you accept them.
`;
